...
You can see a pie chart of colors using the `graphics::pie()` function:
...
Defensive EPA per play during the 2025 NFL season is depicted as a function of offensive EPA per play in @fig-plotDefOffEPA using the `nflplotR` package [@R-nflplotR].

```{r}
#| label: fig-plotDefOffEPA
#| fig-cap: "2025 NFL Offensive and Defensive EPA Per Play."
#| fig-alt: "2025 NFL Offensive and Defensive EPA Per Play."
