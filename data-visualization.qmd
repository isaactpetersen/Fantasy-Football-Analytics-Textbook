...
The `ggplot2` package [@R-ggplot2] is based on the grammar of graphics [@ggplot3rdEd], which is the principle that you can build any graph from three components: 1) the data set, 2) the coordinate system, and 3) the geoms—visual marks that represent data points.
...
### Geoms {#sec-ggplot2SyntaxGeoms}

Here is a list of common geoms available in `ggplot2` (there are many others):
