...
### Histogram with Overlaid Density Plot {#sec-histogramDensity}

A histogram of fantasy points with an overlaid density plot is depicted in @fig-histogramDensity.

```{r}
#| label: fig-histogramDensity
#| fig-cap: "Histogram with Overlaid Density Plot."
...
To display bars corresponding to a 95% confidence interval, we first compute summary statistics:
