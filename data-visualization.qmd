...
- [histogram](#sec-histogram): `geom_histogram()`
- [density plot](#sec-densityPlot): `geom_density()`
- [box-and-whisker plot](#sec-boxAndWhiskerPlot): `geom_boxplot()`
- [violin plot](#sec-violinPlot): `geom_violin()`
- [bar plot](#sec-barPlot): `geom_bar()`
- [scatterplot](#sec-scatterplot): `geom_point()`
- [rug plot](#sec-scatterplotRugPlot): `geom_rug()`
- [line chart](#sec-lineChart): `geom_line()`
- statistical summary (e.g., [best-fit line](#sec-scatterplotBestFitLine)): `geom_smooth()`
