...
The `ggplot2` package [@R-ggplot2] is based on the grammar of graphics [@ggplot3rdEd], which is the principle that you can build any graph from three components: 1) the data, 2) the coordinate system and aesthetics, and 3) the geometries ("geoms")—visual marks that represent data points.
...
### Geometries {#sec-ggplot2SyntaxGeoms}

Here is a list of common geometrics ("geoms") available in `ggplot2` (there are many others):
...
A full list of point shapes available is provided here: <https://ggplot2.tidyverse.org/articles/ggplot2-specs.html> (archived at <https://perma.cc/N9ED-6LUS>).
