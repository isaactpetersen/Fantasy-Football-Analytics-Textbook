...
In these situations, one possible approach is to exercise one's best possible judgment in the moment based on the available evidence [i.e., intuitive decision-making processes; @Jacinto2018], but to check it against an actuarial model after the fact.
