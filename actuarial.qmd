...
Actuarial methods can take time to apply—they require assessing the releving criteria, putting the assessment scores into an actuarial formula, and interpreting the output score.
...
Thus, it can be challenging or impractical in some situations to conduct all of the relevant assessments using actuarial approaches.
...
In these situations, one possible approach is to exercise their best possible judgment based on the available evidence [i.e., intuitive decision-making processes; @Jacinto2018], but to check it against an actuarial model after the fact.
It is valuable to evaluate to receive feedback on the accuracy of one's judgments and, when time permits, to evaluate one's intuitive decision-making against analytical decision-making.
