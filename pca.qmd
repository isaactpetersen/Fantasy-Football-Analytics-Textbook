...
dataMergedWithPCA %>% 
  arrange(-TC1) %>% 
  head %>% 
  select(player_display_name, season, week, all_of(component1vars))
```
...
dataMergedWithPCA %>% 
  arrange(-TC2) %>% 
  head %>% 
  select(player_display_name, season, week, all_of(component2vars))
```
...
dataMergedWithPCA %>% 
  arrange(-TC3) %>% 
  head %>% 
  select(player_display_name, season, week, all_of(component3vars))
```
