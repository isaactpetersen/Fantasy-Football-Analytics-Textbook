...
The model-predicted value of zero fantasy points for Quarterbacks is at `{r} fbZeroAge`.
...
The model-predicted value of zero fantasy points for Quarterbacks is at `{r} rbZeroAge`.
...
The model-implied peaks of Running Backs' fantasy points are at ages `{r} wrPeakAge` and `{r} wrPeakAge2`.
The model-predicted value of zero fantasy points for Quarterbacks is at `{r} wrZeroAge`.
...
The model-implied peak of Running Backs' fantasy points is at age `{r} tePeakAge`.
The model-predicted value of zero fantasy points for Quarterbacks is at `{r} teZeroAge`.
