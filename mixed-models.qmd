...
#mgcv smooth terms: https://stat.ethz.ch/R-manual/R-devel/library/mgcv/html/smooth.terms.html

#bayesianMixedModelFormula <- brms::bf(
#  fantasy_points ~ positionFactor + s(ageCentered20, by = #positionFactor) + years_of_experience + s(ageCentered20, #player_idFactor, bs = "fs") + (1 | player_idFactor)
#)

#bayesianMixedModelFormula <- brms::bf(
#  fantasy_points ~ positionFactor + s(ageCentered20, by = #positionFactor) + years_of_experience + (1 | player_idFactor)
#)
...
load("./data/bayesianMixedModelFit.RData")
```

```{r}
#| include: false

load("https://osf.io/download/q6rjf/")
```
