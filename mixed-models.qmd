...
#### Quadratic Model {#sec-fantasyPointsByAgeExperienceModelsRegressionLinear}
...
plot_individualFantasyPointsPosition <- ggplot(
  ...
  labs(
    x = "Player Age (years)",
    y = "Fantasy Points (Season)",
    title = "Fantasy Points (Season) by Player Age and Position: Random Intercepts Model With Position As Predictor",
    color = "Position"
  ) +
  theme_classic()
...
plot_individualFantasyPointsFixedLinearSlopes <- ggplot(
  ...
  labs(
    x = "Player Age (years)",
    y = "Fantasy Points (Season)",
    title = "Fantasy Points (Season) by Player Age and Position: Model With Random Intercepts and Fixed Slopes",
    color = "Position"
  ) +
  theme_classic()
...
plot_individualFantasyPointsRandomLinearSlopes <- ggplot(
  ...
  labs(
    x = "Player Age (years)",
    y = "Fantasy Points (Season)",
    title = "Fantasy Points (Season) by Player Age and Position: Model With Random Intercepts and Random Linear Slopes",
    color = "Position"
  ) +
  theme_classic()
