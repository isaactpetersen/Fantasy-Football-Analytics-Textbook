...
When estimating mixed models, it is important to know the structure of the data.
...
pointsPerSeason_positionAge_newData$player_idFactor <- factor(
  rep(levels(player_stats_seasonal_offense_subset$player_idFactor)[1], nrow(pointsPerSeason_positionAge_newData)), 
  levels = model_levels
)
