...
An type of ecological fallacy is [Simpson's paradox](#sec-simpsonsParadox).
...
We compare models using the `bbmle` [@R-bbmle] and `MuMIn` [@R-MuMIn] packages.
...
To obtain standardized regression coefficients, we use the `lm.beta.lmer()` function of the [`petersenlab`](https://cran.r-project.org/web/packages/petersenlab/index.html) package [@R-petersenlab].
...
petersenlab::lm.beta.lmer(pointsPerSeason_position)
...
petersenlab::lm.beta.lmer(pointsPerSeason_positionAgeFixedLinearSlopes)
...
petersenlab::lm.beta.lmer(pointsPerSeason_positionAgeRandomLinearFixedQuadraticSlopes)
...
petersenlab::lm.beta.lmer(pointsPerSeason_positionAgeRandomLinearFixedQuadraticSlopesInteraction)
...
petersenlab::lm.beta.lmer(pointsPerSeason_positionAgeRandomLinearFixedQuadraticSlopesInteractionExperience)
