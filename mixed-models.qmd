...
To visualize the regression coefficients, we can use the `tidy()` function of the `broom.mixed` package, as in @fig-individualFantasyPointsRandomLinearFixedQuadraticSlopesInteractionCoefficients.
...
To visualize the regression coefficients, we can use the `tidy()` function of the `broom.mixed` package, as in @fig-bayesianRegressionCoefficients.
...
To visualize the distribution of regression coefficients, we can use the `tidybayes` package, as in @fig-bayesianRegressionCoefficientsDistributions.
