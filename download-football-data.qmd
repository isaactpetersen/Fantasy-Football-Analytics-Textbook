...
Now, modify the scoring settings to match our league settings (based on [scoring settings](https://support.nfl.com/hc/en-us/articles/4989179237404-Scoring) for fantasy leagues on NFL.com):
...
scoring_obj$pts_bracket[[3]]$threshold <- 13
scoring_obj$pts_bracket[[3]]$points <- 4

scoring_obj$pts_bracket[[4]]$threshold <- 20
scoring_obj$pts_bracket[[4]]$points <- 1

scoring_obj$pts_bracket[[5]]$threshold <- 27
scoring_obj$pts_bracket[[5]]$points <- 0

scoring_obj$pts_bracket[[6]] <- list(
  threshold = 34,
  points = -1
)

scoring_obj$pts_bracket[[7]] <- list(
  threshold = 99,
  points = -4
)
```
