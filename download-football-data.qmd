...
This chapter uses extensive use of merging to process the data for later use.
...
The `players_projectedPoints_seasonal`, `players_projectedStatsAverage_seasonal`, and `players_projectedPointsAverage_seasonal` objects are in `player`-`average type`-`position` form.
