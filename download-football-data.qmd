...
From 2025 onwards, depth charts are not assigned a week.
Instead, each update provides a new ISO8601-formatted timestamp that users can assign to any point in time during the season.
...
nfl_depthCharts <- nfl_depthCharts_raw |> 
  select(gsis_id, season, week, depth_position, everything()) |> #NOTE: the data structure changed beginning in the 2025 season: https://nflreadr.nflverse.com/articles/dictionary_depth_charts.html
