...
[ADD LINKS TO SOURCES OF RANKINGS/PROJECTIONS/ADP/AAV, ETC]
...
We can also consider a player's value over a typical replacement player at that position (shortened to "value over replacement player").
...
Uncertainty is not necessarily a bad thing for a player.
It just means we have less confidence about how they may be expected to perform.
