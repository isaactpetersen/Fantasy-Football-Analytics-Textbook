...
rsquare_onePredictor <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
```
...
rsquare_multiplePredictors <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
...
rsquare_lasso <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
...
rsquare_ridge <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
...
rsquare_elasticNet <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
...
We evaluate it and tune two parameters with cross-validation.
...
rsquare_randomForest <- petersenlab::accuracyOverall(
  predicted = df$pred,
  actual = df$fantasyPoints_lag,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
...
rsquare_treeBoosting <- petersenlab::accuracyOverall(
  predicted = predictedVsActual$predictedPoints,
  actual = predictedVsActual$actualPoints,
  dropUndefined = TRUE
)$rsquared %>% round(., digits = 2)
