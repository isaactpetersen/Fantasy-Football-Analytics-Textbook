...
The most accurate models, in terms of [discrimination](#sec-discrimination) ($R^2$), had an $R^2$ of `{r} rsquare_maximum`, and it was achieved using the [tree-boosting model](#sec-treeBoosting) and with [regression with one predictor](#sec-regressionOnePredictor): the player's fantasy points in the previous season.
