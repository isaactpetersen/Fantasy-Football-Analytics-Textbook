...
We evaluate the accuracy of the model's predictions on the test data using the `accuracyOverall()` of the [`petersenlab`](https://cran.r-project.org/web/packages/petersenlab/index.html) package [@R-petersenlab].
