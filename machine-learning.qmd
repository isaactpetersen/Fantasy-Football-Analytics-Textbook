...
# QBs
seasonalData_lag_qb_all_imp <- missForest::missForest(
...
seasonalData_lag_qb_all_imp$OOBerror
data_all_qb <- cbind(seasonalData_lag_qb_all[,"gsis_id"], seasonalData_lag_qb_all_imp$ximp)
...
seasonalData_lag_qb_train_imp <- missForest::missForest(
...
seasonalData_lag_qb_train_imp$OOBerror
data_train_qb <- cbind(seasonalData_lag_qb_train[,"gsis_id"], seasonalData_lag_qb_train_imp$ximp)
data_train_qb_matrix <- data_train_qb %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

seasonalData_lag_qb_test_imp <- missForest::missForest(
  seasonalData_lag_qb_test %>% 
    select(-gsis_id) %>%
    data.frame(),
  verbose = TRUE,
  mtry = 100,
...
seasonalData_lag_qb_test_imp$OOBerror
data_test_qb <- cbind(seasonalData_lag_qb_test[,"gsis_id"], seasonalData_lag_qb_test_imp$ximp)
data_test_qb_matrix <- data_test_qb %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

# RBs
seasonalData_lag_rb_all_imp <- missForest::missForest(
...
seasonalData_lag_rb_all_imp$OOBerror
data_all_rb <- cbind(seasonalData_lag_rb_all[,"gsis_id"], seasonalData_lag_rb_all_imp$ximp)
...
seasonalData_lag_rb_train_imp <- missForest::missForest(
...
seasonalData_lag_rb_train_imp$OOBerror
data_train_rb <- cbind(seasonalData_lag_rb_train[,"gsis_id"], seasonalData_lag_rb_train_imp$ximp)
data_train_rb_matrix <- data_train_rb %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

seasonalData_lag_rb_test_imp <- missForest::missForest(
  seasonalData_lag_rb_test %>% 
    select(-gsis_id) %>%
    data.frame(),
  verbose = TRUE,
  mtry = 100,
...
seasonalData_lag_rb_test_imp$OOBerror
data_test_rb <- cbind(seasonalData_lag_rb_test[,"gsis_id"], seasonalData_lag_rb_test_imp$ximp)
data_test_rb_matrix <- data_test_rb %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

# WRs
seasonalData_lag_wr_all_imp <- missForest::missForest(
...
seasonalData_lag_wr_all_imp$OOBerror
data_all_wr <- cbind(seasonalData_lag_wr_all[,"gsis_id"], seasonalData_lag_wr_all_imp$ximp)
...
seasonalData_lag_wr_train_imp <- missForest::missForest(
...
seasonalData_lag_wr_train_imp$OOBerror
data_train_wr <- cbind(seasonalData_lag_wr_train[,"gsis_id"], seasonalData_lag_wr_train_imp$ximp)
data_train_wr_matrix <- data_train_wr %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

seasonalData_lag_wr_test_imp <- missForest::missForest(
  seasonalData_lag_wr_test %>% 
    select(-gsis_id) %>%
    data.frame(),
  verbose = TRUE,
  mtry = 100,
...
seasonalData_lag_wr_test_imp$OOBerror
data_test_wr <- cbind(seasonalData_lag_wr_test[,"gsis_id"], seasonalData_lag_wr_test_imp$ximp)
data_test_wr_matrix <- data_test_wr %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

# TEs
seasonalData_lag_te_all_imp <- missForest::missForest(
...
seasonalData_lag_te_all_imp$OOBerror
data_all_te <- cbind(seasonalData_lag_te_all[,"gsis_id"], seasonalData_lag_te_all_imp$ximp)
...
seasonalData_lag_te_train_imp <- missForest::missForest(
...
seasonalData_lag_te_train_imp$OOBerror
data_train_te <- cbind(seasonalData_lag_te_train[,"gsis_id"], seasonalData_lag_te_train_imp$ximp)
data_train_te_matrix <- data_train_te %>%
  mutate(across(where(is.factor), ~ as.numeric(as.integer(.)))) %>% 
  as.matrix()

seasonalData_lag_te_test_imp <- missForest::missForest(
  seasonalData_lag_te_test %>% 
    select(-gsis_id) %>%
    data.frame(),
  verbose = TRUE,
  mtry = 100,
...
seasonalData_lag_te_test_imp$OOBerror
data_test_te <- cbind(seasonalData_lag_te_test[,"gsis_id"], seasonalData_lag_te_test_imp$ximp)
...
#pred_vars_qb_categorical <- "" # to specify categorical predictors
...
#gpb.Dataset.set.categorical(gp_data_qb, pred_vars_qb_categorical) # to specify categorical predictors
...
mean((data_test_qb_matrix[,"fantasyPoints_lag"] - y_pred_test_qb)^2)
