...
The most accurate model, in terms of $R^2$, had an $R^2$ of `{r} rsquare_maximum`, and it was achieved using [regression with one predictor](#sec-regressionOnePredictor): the player's fantasy points in the previous season.
...
The most accurate model in terms of [mean absolute error](#sec-meanAbsoluteError) was the [tree-boosting model](#sec-treeBoosting), which had a [mean absolute error](#sec-meanAbsoluteError) of `{r} mae_minimum`.
