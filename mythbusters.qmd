...
load(file = "./data/player_stats_weekly.RData") #load(file = "./data/nfl_actualStats_weekly.RData")
load(file = "./data/player_stats_seasonal.RData") #load(file = "./data/nfl_actualStats_seasonal.RData")
...
We examine two mixed-effects models for each outcome variable.
One that accounts for the effects of age and experience, and one that does not.
The model that accounts for the effects of age and experience includes random intercepts and random linear slopes, along with a fixed quadratic effect of age to allow for curvilinear effects and a fixed effect of experience.
