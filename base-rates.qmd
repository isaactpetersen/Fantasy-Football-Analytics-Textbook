...
### Example 2: Does a Woman Have Cancer? {#sec-nateSilverExample2}
...
#### Example 3A {#sec-nateSilverExample3A}
...
#### Example 3B {#sec-nateSilverExample3B}

Example 3B: Now, consider that a second plan just hit the World Trade Center.
...
Here is a nomogram plot from [Example 1](#sec-nateSilverExample1) from @Silver2012 (where [specificity](#sec-specificity) equals 1 minus the [false positive rate](#sec-falsePositiveRate)):
...
Here is a nomogram plot from [Example 2](#sec-nateSilverExample2) from @Silver2012 (where [specificity](#sec-specificity) equals 1 minus the [false positive rate](#sec-falsePositiveRate)):
...
Here is a nomogram plot from [Example 3A](#sec-nateSilverExample3A) from @Silver2012 (where [specificity](#sec-specificity) equals 1 minus the [false positive rate](#sec-falsePositiveRate)):
...
Here is a nomogram plot from [Example 3B](#sec-nateSilverExample3B) from @Silver2012 (where [specificity](#sec-specificity) equals 1 minus the [false positive rate](#sec-falsePositiveRate)):
