...
Error cancellation deals with the idea that some individuals' predictions will fall above the truth and some individuals' predictions will fall below the truth—i.e., individual judgments will "bracket" the truth [@Mannes2014].
So, the average of the predictions will "cancel out" some of the errors so that the predictions average out to more closely approximate the truth.
...
- the projections are made independently
...
However, the crowd is not accurate in all situations or domains.
