...
If the bracketing rate is high, the crowd-averaged predictions will be more accurate—in terms of [median absolute error](#sec-medianAbsoluteError)—than most individual forecasters; however, if the bracketing rate is low, the crowd-averaged predictions can be less accurate than than most individual forecasters.
...
Depending on how far some of the individual projections are from the truth, the crowd-averaged projections can be less accurate—in terms of [median absolute error](#sec-medianAbsoluteError)—than most individual forecasters.
