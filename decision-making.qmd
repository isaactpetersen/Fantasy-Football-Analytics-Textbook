...
Indeed, when at least some of of the projections bracket the truth, averaged predictions must be more accurate than the average individual forecaster—in terms of [mean absolute error](#sec-meanAbsoluteError) (MAE) (not in terms of the forecaster at the 50th percentile)—and averaged predictions are often much more accurate [@Larrick2024].
If none of the projections bracket the truth—e.g., all projections overestimate the truth—averaged predictions will be as acurate than the average individual forecaster in terms of [mean absolute error](#sec-meanAbsoluteError) [@Larrick2024].
...
Moreover, averaged projections tend to be more accurate than consensus-based judgments from groups of people that interact and discuss, due to cognitive biases associated with the social interaction among groups, such as herding in which people align their behavior with others [@Mannes2014; @Simoiu2019].

There are well-known prediction markets that allow you to see the crowd-average prediction for various events:
