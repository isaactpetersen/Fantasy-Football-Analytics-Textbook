...
The best funds from 1991–1995 were not necessarily the best funds from 1996–2000.
...
Moreover, even if the stock market is relatively efficient in terms of valuing stocks based on the available information, your fantasy football league is likely not.
...
Modern portfolio theory is a framework for determining the optimal composition of an investment portfolio to maximize expected returns for a given level of risk.
...
That is, higher returns generally requires taking on additional risk—at least as long as we stay along the [efficient frontier](#sec-efficientFrontier), described next.

## The Efficient Frontier of a Stock Portfolio {#sec-efficientFrontier}

The ultimate goal in fantasy football is to draft players for your starting lineup that provide the most projected points and the smallest downside risk.
...
### Based on Historical Game-to-Game Variability {#sec-efficientFrontierFantasyProjectionsUncertainty}
...
You are most likely to pick the best players if you go with the wisdom of the crowd (e.g., average projections across projection sources) and diversify.
