...
To create DAGs, you can use the `R` package `dagitty` [@R-daggity; @Textor2016_packages] or the associated browser-based extension, DAGitty: <https://dagitty.net> (archived at <https://perma.cc/U9BY-VZE2>).
