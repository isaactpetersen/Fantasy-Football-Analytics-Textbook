...
![Video that Provides An Introduction to American Football.](images/football.mp4){width=100%}
...
![An Example Football Formation for the Offense and Defense.](images/footballFormation.png){#fig-footballFormation}
...
A diagram of a football field is depicted in Figure @fig-footballField.

::: {#fig-footballField}
![](images/footballField.png)

A Diagram of a Football Field. The yard markers depict the distance from the nearest end zone. The orange shaded area is called the "red zone", where chances of scoring points are highest. The original figure was modified by adding field goal posts. (Figure retrieved from https://commons.wikimedia.org/wiki/File:American_football_field.svg)
:::
...
![Video that Provides an Introduction to Fantasy Football.](images/fantasyFootball.mp4){width=100%}
