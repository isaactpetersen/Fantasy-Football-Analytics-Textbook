...
To visualize the regression coefficients, we can use the `tidy()` function of the `broom` package, as in Figures [-@fig-regressionCoefficients] and [-@fig-regressionCoefficientsStandardized].
