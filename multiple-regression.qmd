...
To evaluate homoscedasticity, we can evaluate a residual plot (@fig-residualPlots) and spread-level plot (@fig-spreadLevelPlots) from the `car` package [@Fox2019_packages; @R-car].
