...
A mediation model takes the following general form in the `lavaan` package [@Rosseel2012; @R-lavaan].
...
multipleMediatorModel <- '
  ...
  fantasyPoints_transformed ~ b1*receiving_tds + b1*receiving_yards
