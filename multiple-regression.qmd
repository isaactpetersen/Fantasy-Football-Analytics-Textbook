...
\begin{aligned}
  ...
  &\phantom{=} \beta_5 \cdot \text{weight} + \beta_6 \cdot \text{weight}^2 + \beta_7 \cdot \text{target share} + \beta_8 \cdot \text{target share}^2 + \epsilon
\end{aligned}
...
\begin{aligned}
  ...
  &\phantom{=} `r petersenlab::apa(beta5, decimals = 2)` \cdot \text{weight} + `r petersenlab::apa(beta6, decimals = 2)` \cdot \text{weight}^2 + `r petersenlab::apa(beta7, decimals = 2)` \cdot \text{target share} + `r petersenlab::apa(beta8, decimals = 2)` \cdot \text{target share}^2 + \epsilon \\
