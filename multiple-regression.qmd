...
For instance, shrinking is observed when applying multiple regression models to new data in @sec-fittingModels-regression and when applying [machine learning](#sec-machineLearning) models to new data in @sec-fittingModels-machineLearning.
