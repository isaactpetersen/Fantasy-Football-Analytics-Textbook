...
When the [outcome variable](#sec-correlationalStudy) is continuous, [linear regression](#sec-multipleRegressionLinear) is common.
...
```{r}
obj <- bestNormalize::bestNormalize(player_stats_seasonal$fantasyPoints)
player_stats_seasonal$fantasyPoints_transformed <- predict(obj)
