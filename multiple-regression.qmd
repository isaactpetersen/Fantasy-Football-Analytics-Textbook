...
We set up the bootstrap folds using the `bootstraps()` function of the `rsample` package [@R-sample].
...
# Compute percentile intervals for the regression coefficients
percentile_intervals <- rsample::int_pctl(boot_models, coef_info)
#percentile_intervals <- rsample::int_pctl(boot_results, results)
