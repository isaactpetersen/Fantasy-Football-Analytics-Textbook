...
In this game, participants compete against their opponents (friends/coworkers/classmates), accumulating points based on players' actual statistical performances in games.
...
However, the class incorporates important psychological concepts, such as cognitive biases in judgment and prediction, etc.
...
This course will teach readers the applications of statistics (prediction) and research methods (empiricism) to answer questions they find interesting, while applying scientific and psychological rigor.
...
![Benjamin Motz on statistics and fantasy football course](images/motzVideo.mp4){width=100%}
