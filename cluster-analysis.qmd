...
We can perform a cluster analysis using the `mclust::mclustBIC()`, `mclust::mclustICL()`, and `mclust::mclustBootstrapLRT()` functions of the `mclust` package [@R-mclust; @Scrucca2023_packages].
