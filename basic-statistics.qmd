...
$$
eta^2 = \frac{\text{variance explained in the dependent variable}}{\text{total variance in the dependent variable}}
$$ {#eq-etaSquaredPartitionedVariance}
...
Solving for sample size per group needed (given effect size, power, and alpha)—$v = N - \text{numberOfPredictors} - 1$; thus, $N = v + \text{numberOfPredictors} + 1$:
