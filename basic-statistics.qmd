...
where $y$ is the [outcome variable](#sec-correlationalStudy), $y_i$ is the observed value of the [outcome variable](#sec-correlationalStudy) for the $i$th observation, $\hat{y}_i$ is the model predicted value for the $i$th observation, $\bar{y}$ is the mean of the observed values of the [outcome variable](#sec-correlationalStudy).
