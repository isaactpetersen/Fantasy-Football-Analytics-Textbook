...
1. We can (correctly) reject the null hypothesis when it is in fact false ($1 - \beta$).
This is a true positive.
For instance, we may correctly determine that Quarterbacks have longer careers than Running Backs.
1. We can (correctly) fail to reject the null hypothesis when it is in fact true ($1 - \alpha$).
This is a true negative.
For instance, we may correctly determine that Quarterbacks do not have longer careers than Running Backs.
1. We can (incorrectly) reject the null hypothesis when it is in fact true ($\alpha$).
This is a false positive.
When performing a null hypothesis testing, a false positive is known as a Type I error.
...
1. We can (incorrectly) fail to reject the null hypothesis when it is in fact false ($\beta$).
This is a false positive.
When performing a null hypothesis testing, a false negative is known as a Type II error.
