...
The [`petersenlab`](https://github.com/DevPsyLab/petersenlab) package [@R-petersenlab] contains various functions for computing weighted quantiles based on @Akinshin2023.
Because some projections are outliers, we use a trimmed version of the weighted Harrell-Davis quantile estimator for greater robustness.
