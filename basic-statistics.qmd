...
To estimate a combination of indices of center, spread, and shape of the data, you can use the following code:
...
Thus, we conclude that there was a significant (non-zero) difference or association.
If the *p*-value is greater than .05, we fail to reject the null hypothesis; the difference/association was not significant.
