...
where $x$ is the [predictor variable](#sec-correlationalStudy), $y$ is the [outcome variable](#sec-correlationalStudy), $\text{Cov}(x, y)$ is the covariance between $x$ and $y$, $s_x$ is the standard deviation of $x$, $s_y$ is the standard deviation of $y$, $n$ is the sample size, $z_x$ is the *z*-score for $x$, and $z_y$ is the *z*-score for $y$.
