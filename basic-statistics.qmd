...
You can use the following web application to visualize various distributions according to a specified [center](#sec-descriptiveStatisticsCenter) (mean), [spread](#sec-descriptiveStatisticsSpread) (standard deviation), and [shape](#sec-descriptiveStatisticsShape) (skewness and kurtosis).
