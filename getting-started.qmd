...
1. After installing `R` and `RStudio`, open `RStudio` (by right clicking and selecting "Run as Administrator") and run the following code in the console to install the `R` packages used in this book (note: this will take a while):
   ```{r}
   #| eval: false
