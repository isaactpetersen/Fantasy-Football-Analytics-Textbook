...
1. In `RStudio`, run the following code in the console to install the `R` packages used in this book (note: this will take a while):
   ...
   install.packages(c(
     ...
     "missRanger","ggridges","powerjoin","bestNormalize","gpboost","mgcv","rms",
     "car","lavaan","lavaanPlot","lavaangui","mice","miceadds","interactions",
     "robustbase","ordinal","MASS","data.table","future","future.apply",
     "SimDesign","domir","GGally","Rglpk","TTR","rockchalk","yhat","tidyLPA"
   ))
   ```
