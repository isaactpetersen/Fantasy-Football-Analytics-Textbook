...
The [`petersenlab`](https://github.com/DevPsyLab/petersenlab) package [@R-petersenlab] has a convenience function, `%ni%`, for the logical operator of determining whether an element is *not* in a value of another vector:
