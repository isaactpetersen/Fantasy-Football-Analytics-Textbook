...
For instance, to learn about the `seq()` function, which creates a sequence of numbers, you can execute the following command:
...
The `seq()` function takes the following arguments:
...
Here is an example of providing values to the arguments in the order indicated by the function:
...
If you want to generate a series with gradually incrementing decimal places, you could specify a long desired sequence of 81 values:
...
save(
  nfl_4thdown,
  file = here("data", "nfl_4thdown.RData")
)
```
