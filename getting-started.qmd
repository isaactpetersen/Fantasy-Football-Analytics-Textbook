...
players$integerVar <- as.integer(players$newVar)
players$characterVar <- as.character(players$newVar1)
```
...
#### Seasonal {#sec-calculateActualPointsWeekly}

#### Career {#sec-calculateActualPointsWeekly}
