...
If a participant has multiple rows corresponding to seasons and games/weeks, the keys are `player_id`, `season`, and `week`—in this case, the data are in `player`-`season`-`week` form.
