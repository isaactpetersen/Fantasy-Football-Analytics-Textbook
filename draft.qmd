...
Section @sec-fantasyValue describes where to obtain aggregated rankings, aggregated projections, ADP, and AAV data.
...
An important concept in the snake draft is a player's value over a typical replacement player at that position (shortened to "value over replacement player"; VORP), which is described in Section @sec-fantasyValue.
In general, your goal is to draft the team whose weekly starting lineup has the greatest VORP.
