...
For instance, if we know the population distribution for the likely outcomes for a player—e.g., a normal distribution with a known mean and standard deviation—we can repeatedly sample randomly from this distribution.
