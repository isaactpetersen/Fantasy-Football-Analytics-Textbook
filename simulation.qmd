...
#### Run the Bootsrapping Simulation {#sec-simulationProjectedPointsBootstrappingRun}
...
bootstrappedFantasyPoints_summary <- bootstrappedFantasyPoints %>% 
  ...
  summarise(
    ...
    q10 = quantile(projectedPoints, .10), # 10th quantile
    q90 = quantile(projectedPoints, .90), # 90th quantile
