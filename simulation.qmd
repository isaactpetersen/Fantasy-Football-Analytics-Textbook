...
```{r}
#| label: code-to-specify-vars-to-bootstrap-by-position
#| eval: false
...
```{r}
#| label: put-simulated-data-in-format-for-scoring
...
You can generate a template for Monte Carlo simulations in the `SimDesign` package using the following code:
