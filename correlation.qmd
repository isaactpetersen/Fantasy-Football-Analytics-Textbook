...
\begin{aligned}
  ...
  &= r_{xy} \cdot \sigma_x \cdot \sigma_y
\end{aligned}
$$ {#eq-covariance}

where $n$ is the sample size, $x$ is the [predictor variable](#sec-correlationalStudy), $y$ is the [outcome variable](#sec-correlationalStudy), $x_i$ is the ith observation on the [predictor variable](#sec-correlationalStudy), $y_i$ is the ith observation of the [outcome variable](#sec-correlationalStudy), $\bar{x}$ is the mean of the [predictor variable](#sec-correlationalStudy), $\bar{y}$ is the mean of the [outcome variable](#sec-correlationalStudy), $r_{xy}$ is the correlation between the [predictor](#sec-correlationalStudy) and [outcome](#sec-correlationalStudy) variables, $\sigma_x$ is the standard deviation of the [predictor variable](#sec-correlationalStudy), and $\sigma_y$ is the standard deviation of the [outcome variable](#sec-correlationalStudy).
