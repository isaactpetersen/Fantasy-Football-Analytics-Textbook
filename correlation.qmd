...
p2 <- ggplot(
  ...
  labs(
    ...
    subtitle = expression(paste(italic("r"), " = ", "−0.9"))
  ) +
  theme_classic(
    base_size = 16) +
  theme(
...
p3 <- ggplot(
  ...
  labs(
    ...
    subtitle = expression(paste(italic("r"), " = ", "−0.5"))
  ) +
  theme_classic(
    base_size = 16) +
  theme(
...
p4 <- ggplot(
  ...
  labs(
    ...
    subtitle = expression(paste(italic("r"), " = ", "−0.2"))
  ) +
  theme_classic(
    base_size = 16) +
  theme(
...
p5 <- ggplot(
  ...
  labs(
    ...
    subtitle = expression(paste(italic("r"), " = ", "0.0"))
  ) +
  theme_classic(
    base_size = 16) +
  theme(
