...
The $r$ value (`{r} petersenlab::apa(pearson_r, decimals = 2)`) is slightly negative.
...
We could report this finding as follows: There was a statistically significant, weak negative association between height and fantasy points ($r[$ `{r} pearson_df` $]=$ `{r} petersenlab::apa(pearson_r, decimals = 2)`, $p < .001$); the taller a player was, the fewer fantasy points they tended to score.
