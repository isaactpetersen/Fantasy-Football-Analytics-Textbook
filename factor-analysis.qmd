...
Although standardizing variables is not strictly necessary in factor analysis, it can be helpful to prevent some variables from having considerably larger variances than others.

```{r}
dataForFA <- dataMerged
