...
packagesForBibliography <- c(
  ...
  "AICcmodavg", "rstan", "brms", "bbmle", "fitdistrplus", "sn", "mclust", "magrittr", 
  "viridis", "plotly", "quantmod", "fPortfolio", "xts", "zoo", "forecast", #"webshot2", 
  "stringi", "parallel", "parallelly", "doParallel", "missRanger", "ggridges", 
  "powerjoin", "caret", "gpboost", "cmdstanr", "learnr", "remotes", "corrplot", 
  "correlation", "mgcv", "rms", "car", "performance", "lavaan", "mice", 
  "miceadds", "interactions", "shiny", "PearsonDS", "robustbase", "data.table", 
  "future", "future.apply", "SimDesign"
)
