...
# Packages to drop: caret (replace with tidymodels)
...
packagesForBibliography <- c(
  ...
  "caret", "LongituRF", "gpboost", "cmdstanr", "mgcv", "rms", "car", "lavaan", 
  "lavaanPlot", "mice", "miceadds", "interactions", "robustbase", "ordinal", 
