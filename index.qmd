...
packagesForBibliography <- c(
  ...
  "nflreadr", "nflplotR", "nflfastR", "nflseedR", "nfl4th", "gsisdecoder", 
  "progressr", "DescTools", "pwr", "pwrss", "WebPower", "XICOR", "dagitty", 
  "ggdag", "lubridate", "ggtext", "gghighlight", "ggExtra", "grid", "patchwork", 
  "pROC",  "lme4", "lmerTest", "MuMIn", "emmeans", "pbkrtest", "sjstats", 
  "AICcmodavg", "rstan", "brms", "bbmle", "fitdistrplus", "sn", "mclust", 
  "magrittr", "viridis", "plotly", "quantmod", "fPortfolio", "NMOF", "xts", #"webshot2",
  "zoo", "forecast", "stringi", "parallel", "parallelly", "doParallel", 
  "missRanger", "ggridges", "powerjoin", "caret", "gpboost", "cmdstanr", 
  "learnr", "remotes", "corrplot", "correlation", "mgcv", "rms", "car", 
  "performance", "lavaan", "mice", "miceadds", "interactions", "shiny", 
  "PearsonDS", "robustbase", "data.table", "future", "future.apply", "SimDesign"
)
