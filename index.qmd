...
# Globally apply message = NA (https://github.com/quarto-dev/quarto-cli/discussions/7443)
knitr::opts_chunk$set(
  time = TRUE,
  message = NA # show messages in console but not book
)
