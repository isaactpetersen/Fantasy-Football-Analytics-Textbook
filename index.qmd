...
packagesForBibliography <- c(
  ...
  "nflreadr", "nflplotR", "nflfastR", "gsisdecoder", "progressr", "DescTools",
  "pwr", "pwrss", "WebPower", "XICOR", "dagitty", "ggdag", "lubridate",
  "ggtext", "gghighlight", "ggExtra", "grid", "patchwork", "pROC", "lme4",
  "lmerTest", "MuMIn", "emmeans", "pbkrtest", "sjstats", "AICcmodavg", "rstan",
  "brms", "bbmle", "fitdistrplus", "mclust", "magrittr", "viridis", "plotly",
  "quantmod", "fPortfolio", "xts", "zoo", "forecast", "stringi", #"webshot2", 
  "parallel", "parallelly", "ggridges", "cmdstanr",
  "learnr", "remotes" #"mgcv",
