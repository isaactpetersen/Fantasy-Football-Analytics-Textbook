...
packagesForBibliography <- c(
  ...
  "knitr", "rmarkdown", "dplyr", "ggplot2", "tidyverse", "broom", "downlit", 
  "xml2", "nflreadr", "nflplotR", "nflfastR", "nflseedR", "nfl4th", 
  ...
  "sjstats", "AICcmodavg", "rstan", "brms", "bbmle", "fitdistrplus", "sn", 
  "mclust", "magrittr", "viridis", "plotly", "quantmod", "fPortfolio", "NMOF", 
  "xts", "zoo", "forecast", "stringi", "parallel", "parallelly", "doParallel", #"webshot2"
  "missRanger", "ggridges", "powerjoin", "caret", "gpboost", "cmdstanr", "learnr", 
  "remotes", "corrplot", "correlation", "mgcv", "rms", "car", "performance", 
  "lavaan", "mice", "miceadds", "interactions", "shiny", "PearsonDS", 
  "robustbase", "data.table", "future", "future.apply", "QuantPsyc", "SimDesign"
)
