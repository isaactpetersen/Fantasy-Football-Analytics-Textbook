...
Petersen, I. T. (2025). *Fantasy football analytics: Statistics, prediction, and empiricism using R*. Version 0.0.1. University of Iowa Libraries. <https://isaactpetersen.github.io/Fantasy-Football-Analytics-Textbook>. [INSERT DOI LINK]
...
In addition, a special thanks to those who contributed to the book via comments, suggestions, and pull requests, including George Ellis ([\@MargareeMan](https://github.com/MargareeMan)).
