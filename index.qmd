...
In particular, Andrew Tungate and Dennis Andersen helped develop the [`ffanalytics` `R` package](https://github.com/FantasyFootballAnalytics/ffanalytics) [@R-ffanalytics], which is useful for scraping fantasy football projections and calculating projections averaged across sources.
