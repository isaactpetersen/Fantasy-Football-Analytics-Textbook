...
packagesForBibliography <- c(
  ...
  "gpboost", "cmdstanr", "learnr", "remotes", "corrplot", "correlation", "mgcv", 
  "rms", "car", "performance", "lavaan", "mice", "miceadds", "interactions", 
  "shiny", "PearsonDS", "robustbase", "data.table", "future", "future.apply", 
