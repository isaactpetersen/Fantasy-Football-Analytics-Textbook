...
Players' performance in fantasy football, and human behavior more generally, is complex and multiply determined.
No one can predict accurately how all players will perform.
Remain humble in your predictions; do not be more confident than you should be.
...
The Dunning–Kruger effect is depicted in @fig-dunningKrueger1 and @fig-dunningKrueger2.
...
Dunning–Krueger Effect. Adapted from <https://commons.wikimedia.org/wiki/File:Effet_Dunning-Kruger.svg>.
:::

::: {#fig-dunningKrueger2}
![](images/dunningKrueger_2.png)

Dunning–Krueger Effect. Adapted from <https://commons.wikimedia.org/wiki/File:Dunning-kruger_effect_-_percentile.svg>.
:::
...
However, in reality, the chance is less than 1 in 4 (24.6%) that exactly 5 of 10 coin flips turn up heads:
