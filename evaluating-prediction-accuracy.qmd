...
::: {#fig-confusionMatrix}
![](images/confusionMatrix.png){fig-alt="A Two-by-Two Confusion Matrix."}
...
![](images/confusionMatrix1.png){fig-alt="Example of a Two-by-Two Confusion Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives."}

Example of a Two-by-Two Confusion Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives.
:::
...
![](images/confusionMatrix2.png){fig-alt="Example of a Two-by-Two Confusion Matrix With Marginal Sums. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives."}

Example of a Two-by-Two Confusion Matrix With Marginal Sums. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives.
:::
...
![](images/confusionMatrix3.png){fig-alt="Example of a Two-by-Two Confusion Matrix With Marginal Sums and Marginal Probabilities. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio."}

Example of a Two-by-Two Confusion Matrix With Marginal Sums and Marginal Probabilities. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio.
:::
...
![](images/confusionMatrix4.png){fig-alt="Chance Expectancies in Two-by-Two Confusion Matrix. BR = base rate; SR = selection ratio."}

Chance Expectancies in Two-by-Two Confusion Matrix. BR = base rate; SR = selection ratio.
:::
