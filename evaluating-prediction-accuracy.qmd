...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal$raw_points,
  projectionsWithActuals_seasonal$fantasyPoints), na.rm = TRUE) + 50
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_qb$raw_points,
  projectionsWithActuals_seasonal_qb$fantasyPoints), na.rm = TRUE) + 50
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_rb$raw_points,
  projectionsWithActuals_seasonal_rb$fantasyPoints), na.rm = TRUE) + 0
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_wr$raw_points,
  projectionsWithActuals_seasonal_wr$fantasyPoints), na.rm = TRUE) + 40
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_te$raw_points,
  projectionsWithActuals_seasonal_te$fantasyPoints), na.rm = TRUE) + 0
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_k$raw_points,
  projectionsWithActuals_seasonal_k$fantasyPoints), na.rm = TRUE) + 100
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_dl$raw_points,
  projectionsWithActuals_seasonal_dl$fantasyPoints), na.rm = TRUE) + 0
...
#### Linebackers {#sec-accuracyProjectionsSeasonalDL}
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_lb$raw_points,
  projectionsWithActuals_seasonal_lb$fantasyPoints), na.rm = TRUE) + 0
...
plotRangeMax <- max(c(
  projectionsWithActuals_seasonal_db$raw_points,
  projectionsWithActuals_seasonal_db$fantasyPoints), na.rm = TRUE) + 0
