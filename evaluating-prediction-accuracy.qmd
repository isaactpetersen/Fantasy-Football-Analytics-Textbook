...
Median absolute error (MdAE) is the median of the absolute value of differences between the predicted and observed values across individuals, that is, the median of the absolute value of errors.
