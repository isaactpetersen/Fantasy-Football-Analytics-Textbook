...
So, to get the chance expectancies of true positives, we would multiply the respective [marginal probabilities](#baseRate), as in Equation @eq-truePositivesByChanceExample:
...
To get the chance expectancies of true negatives, we would multiply the respective [marginal probabilities](#sec-baseRate), as in @trueNegativesByChanceExample:
...
## Prediction of Continuous Outcomes {#sec-predictionCategorical}
