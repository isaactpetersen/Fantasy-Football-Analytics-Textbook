...
To generate a 2x2 confusion matrix, we need to make a dichotomous decision/prediction.
...
Thus, the same player has multiple rows in the data file—one for each projection source.
